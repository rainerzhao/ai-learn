...
5\. Prepare (or [download](exer2_batch.txt.md)) the batch file and save it as _batch\_test.sh_ (or pick any filename). Remember to submit the job to one of the GPU queues, such as Frontera's `rtx-dev` queue.
