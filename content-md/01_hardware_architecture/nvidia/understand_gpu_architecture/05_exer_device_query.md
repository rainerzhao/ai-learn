...
1\. Copy and paste (or [download](exer1.txt.md)) the following code into a new file named _devicequery.cu_.
...
4\. Prepare (or [download](exer1_batch.txt.md)) the batch file and save it as _batch.sh_ (or you can pick any filename). Remember to specify one of the GPU queues, such as Frontera's `rtx-dev` queue.
