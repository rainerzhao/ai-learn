...
我们从 2024 年 6 月就开始追踪这种演变，当时我们写了关于《`AI Agent 基础设施的崛起` ⚠️ (原文链接)》的文章。那时，这个领域还很稀疏，主要由 DIY 解决方案主导，因为开发者优先考虑灵活性来试验不同的方法。有一大批新公司在为 Agent 的未来状态构建基础设施，但这些公司面临着一个移动的目标。
